...
/**
 * Returns a negative animation-delay that phases this element's idle-pulse
 * animation to the shared clock.
 *
 ...
 * be — which is what a negative CSS animation-delay does.
 */
